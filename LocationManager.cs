...
public class ForgottenGrove : Location
{
    public ForgottenGrove() : base("A dense forest covered in mist where travelers often lose their way. The silence is broken only by strange rustling sounds.")
    {
        ...
        EnemyTypes.Add(() => new Enemy("Forest Wolf", 30, strength: 4, endurance: 2, agility: 5, luck: 2, level: 1));
        EnemyTypes.Add(() => new Enemy("Lost Spirit", 20, strength: 3, endurance: 1, agility: 6, luck: 3, level: 1));
        EnemyTypes.Add(() => new Enemy("Small Bandit", 25, strength: 4, endurance: 2, agility: 3, luck: 1, level: 1));
    }
}
...
public class AbandonedVillage : Location
{
    public AbandonedVillage() : base("Crumbling houses and empty streets. Something… or someone… still lingers here.")
    {
        ...
        EnemyTypes.Add(() => new Enemy("Undead Farmer", 55, strength: 7, endurance: 6, agility: 2, luck: 1, level: 3));
        EnemyTypes.Add(() => new Enemy("Shadowy Figure", 35, strength: 11, endurance: 3, agility: 7, luck: 3, level: 4));
        EnemyTypes.Add(() => new Enemy("Raider", 60, strength: 10, endurance: 5, agility: 3, luck: 2, level: 5));
    }
}
...
public class DarkCavern : Location
{
    public DarkCavern() : base("A deep cave filled with echoes and unknown creatures. Light does not last long here.")
    {
        ...
        EnemyTypes.Add(() => new Enemy("Cave Spider", 65, strength: 11, endurance: 5, agility: 7, luck: 2, level: 5));
        EnemyTypes.Add(() => new Enemy("Stone Golem", 85, strength: 9, endurance: 10, agility: 1, luck: 1, level: 7));
        EnemyTypes.Add(() => new Enemy("Bat Swarm", 55, strength: 13, endurance: 4, agility: 8, luck: 3, level: 8   ));
    }
}
...
public class BurndenRuins : Location
{
    public BurndenRuins() : base("The remains of a city destroyed by fire. Ash still falls from the sky.")
    {
        ...
        EnemyTypes.Add(() => new Enemy("Flame Wraith", 75, strength: 14, endurance: 5, agility: 6, luck: 3, level: 8));
        EnemyTypes.Add(() => new Enemy("Ashen Knight", 95, strength: 18, endurance: 11, agility: 4, luck: 2, level: 10));
        EnemyTypes.Add(() => new Enemy("Fire Elemental", 110, strength: 22, endurance: 8, agility: 7, luck: 4, level: 12));
    }
}
...
public class FrozenPeak : Location
{
    public FrozenPeak() : base("Icy mountains where only the strongest survive. Every step could be your last.")
    {
        ...
        EnemyTypes.Add(() => new Enemy("Ice Golem", 100, strength: 20, endurance: 15, agility: 5, luck: 2, level: 12));
        EnemyTypes.Add(() => new Enemy("Frost Sorcerer", 80, strength: 25, endurance: 5, agility: 10, luck: 3, level: 14));
        EnemyTypes.Add(() => new Enemy("Yeti", 120, strength: 30, endurance: 20, agility: 8, luck: 4, level: 16));
    }
}
